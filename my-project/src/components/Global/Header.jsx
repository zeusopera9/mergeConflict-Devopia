...
const Header = () => {
    ...
    useEffect(() => {
        ...
        try {
            const response = await fetch('http://localhost:7000/check-login');
                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    {loggedIn ? (
                        <div className="flex items-center lg:order-2">
                            <a href="/auth" className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Log out</a>
                        </div>
                    ) : (
                        <div className="flex items-center lg:order-2">
